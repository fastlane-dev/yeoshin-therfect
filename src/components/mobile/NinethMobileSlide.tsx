    ...
    >
      <div className="relative pb-[60px] text-[10px] font-[300] leading-[18px] text-[#555555]">
        ...
        <p>
          ...
          유사문구를 무단으로 사용하는 것은 '부정경쟁방지 및 영업비밀보호에 관한
          법률'상의 부정경쟁 행위에 해당합니다. Therfect™, 써펙트™는 식약처
          허가를 받은 의료기기입니다. 범용전기수술기로, 고주파 전류를 사용하여
          조직의 응고에 사용하는 기구입니다. 이 제품은 '의료기기'이며, '사용상의
      ...
      <div className="mt-[64px]  font-[400]">
        <p className="item-center flex justify-between">
          <div className="h-[23px] w-[123px]">
            <img src={"/img/ys_medi_logo.svg"} alt="ys_medi_logo" />
          </div>
